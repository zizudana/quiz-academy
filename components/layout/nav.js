    ...
    <>
      ...
      >
        ...
        <div id="nav-right" className="text-white">
          <Link href="/user/quiz-set">
            <a className="hidden md:inline-block px-2 py-0 hover:text-indigo-200">
              문제풀이
            </a>
          </Link>
          ...
          <button
            onClick={() => toggle_hidden_header()}
            className="md:hidden color-3 text-white font-bold leading-4 rounded p-2 ml-3"
          >
            =
          </button>
        </div>
      ...
      <div id="hidden-header" className="hidden md:hidden px-6 py-2 color-3">
        <Link href="/user/pdf">
          <a
            onClick={() => toggle_hidden_header()}
            className="block px-2 py-2 font-bold text-white hover:bg-indigo-200 rounded"
          >
            문제풀이
          </a>
        </Link>
