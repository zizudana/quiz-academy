const PDFPage = () => {
  return (
    <>
      {/* 문제 제목 */}
      <div className="w-1/2 mx-auto text-center pt-5 pb-4 rounded">
        <div className="bg-indigo-800 text-indigo-100 px-4 py-3 leading-none rounded-full" role="alert">
      ...
      <div className="grid grid-cols-4 gap-3 mt-4">
        <div className="col-span-1 flex justify-start">
          ...
          <button className="bg-gray-300 hover:bg-gray-400 h-full text-gray-800 px-4 rounded flex items-center">
            <span className="keep-all">이전 문제</span>
            {/* previous icon svg */}
            <svg className="fill-current w-6 h-6 ml-3" enableBackground="new 0 0 64 64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="col-span-1 flex justify-end">
          ...
          <button className="bg-gray-300 hover:bg-gray-400 h-full text-gray-800 px-4 rounded flex items-center">
            {/* next icon svg */}
            <svg className="fill-current w-6 h-6 mr-3" enableBackground="new 0 0 64 64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="keep-all">다음 문제</span>
          </button>
        </div>
      </div>
    </>
